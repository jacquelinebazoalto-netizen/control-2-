...
%%
% Lectura de datos 
values   = xlsread('Curvas_Medidas_RLC_2026.xls'); 
time     = values(1:end,1);
...
t1_v = values(1300,1); y1_v = values(1300,3); 
t2_v = values(1600,1); y2_v = values(1600,3);
t3_v = values(2255,1); y3_v = values(2255,3);
...
% 1) Elección de valores sobre el plot de Vc
t1_i = values(1300,1); y1_i = values(1300,2); 
t2_i = values(1500,1); y2_i = values(1500,2);
t3_i = values(1700,1); y3_i = values(1700,2);
